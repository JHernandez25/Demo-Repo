    ...
    var WebSlides = function () {
      ...
      _createClass(WebSlides, [{
        ...
        value: function onSlideChange_(slide) {
          ...
          // ****************** Stops Video From Playing on other slides ********************
          try {
            vid.pause();
          }

          catch (err) {
            console.log("No Video Slide");
          }
        ...
        value: function goNext() {
          ...
          /***Pauses the audio when the user clicks next slide.  Update 8-16-2021.   Version 1.1 */
          ...
          if (this.currentSlide_) {
            ...
            // if all links have been click or not on slide 6 continue 
            else {
              this.goToSlide(nextIndex, true);
            }
          }
          try {
            for (var aud = 0; aud < audio.length; aud++) {
              audio[aud].pause();
            }
          }
          catch (err) {
            console.log("No Audio Slide");
          }
        ...
        value: function goPrev() {
          ...
          /***Pauses the audio when the user clicks previous slide.  Update 8-16-2021.   Version 1.1 */
          var audio = document.getElementsByClassName("myAudio");
